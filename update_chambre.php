        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h2 class="text-primary">Modification du montant</h2><hr>
                    <form method="post" action="updatecible.php">
                    <div class="form-group">
                      <label>Num̩ro :</label>
                      <input type="text" class="form-control form-control-lg" required disabled placeholder="Numero" aria-label="Username" name="numero" value="<?php echo $numero;  ?>">
                    </div>
                    <div class="form-group">
                      <label>Montant <!--<?php echo '<span style="font-size:0.9em;color:red">('.$montant.' USD)</span>';  ?>--> :</label>
                      <input type="text" class="form-control form-control-lg" required autofocus placeholder="Nouveau montant" aria-label="Username" name="montant" value="<?php echo $montant;  ?>">
                    </div>
